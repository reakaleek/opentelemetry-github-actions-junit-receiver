...
// Copied partially from https://github.com/unelastisch/opentelemetry-collector-contrib/blob/feature/skip-other-event-types/receiver/githubactionsreceiver/trace_attributes.go
